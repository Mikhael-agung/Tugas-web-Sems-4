<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto mt-6">
        ...
        <form action="{{ route('transaksi.store.keluar') }}" method="post" class="space-y-4">
            @csrf
            <div>
                ...
                <select name="barang_id" id="barang_id" class="w-full mt-1 border rounded">
                    ...
                    @foreach ($barang as $item)
                        <option value="{{ $item->id }}" @selected(old('barang_id') == $item->stock)>
            ...
            <div>
                ...
                <input type="number" name="jumlah" id="keterangan"
